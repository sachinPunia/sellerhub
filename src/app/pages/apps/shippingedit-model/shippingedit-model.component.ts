...
@Component({
  selector: 'vex-shippingedit-model',
  templateUrl: './shippingedit-model.component.html',
  styleUrls: ['./shippingedit-model.component.scss'],
...
export class ShippingeditModelComponent implements OnInit {

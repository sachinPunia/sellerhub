...
@Component({
  selector: 'vex-ebaytestconnection-model',
  templateUrl: './ebaytestconnection-model.component.html',
  styleUrls: ['./ebaytestconnection-model.component.scss']
})
export class EbaytestconnectionModelComponent implements OnInit {
  ...
  testconnection(){
    this.urlApi.getEbayTestCon(this.id).subscribe(() => {},(token:any) => {
      // debugger;
      console.log(token);

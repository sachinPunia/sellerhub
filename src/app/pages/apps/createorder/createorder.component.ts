...
import faaddress from '@iconify/icons-fa-solid/address-card';
import faaddress1 from '@iconify/icons-fa-solid/address-book';
import facubes from '@iconify/icons-fa-solid/cubes';


@Component({
  selector: 'vex-createorder',

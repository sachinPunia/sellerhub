...
@Component({
  selector: 'vex-invetory-stockview',
  templateUrl: './invetory-stockview.component.html',
  styleUrls: ['./invetory-stockview.component.scss'],
...
export class InvetoryStockviewComponent implements OnInit {
  ...
  columns: TableColumn<Stockview>[] = [
    ...
    { label: 'Price', property: 'sellingPrice', type: 'text', visible: true, cssClasses: ['font-medium'] },
  ...
  onSearch() {
    ...
    this.urlApi.getStockview(1,100,100,this.searchBy, this.searchByInput,'','','','', false)
      .subscribe((stockview:any) => {
        // this.subject$.next(stockview);
        try {
          const result: Stockview[] = stockview?.products || [];

...
@Component({
  selector: 'vex-packlist-model',
  templateUrl: './packlist-model.component.html',
  styleUrls: ['./packlist-model.component.scss']
})
export class PacklistModelComponent implements OnInit {

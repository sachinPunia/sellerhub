...
@Component({
  selector: 'vex-paid-model',
  templateUrl: './paid-model.component.html',
  styleUrls: ['./paid-model.component.scss']
})
export class PaidModelComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.urlApi.getPaidModel(this.data)
      .subscribe((resp: any) => {

...
@Component({
  selector: 'vex-ordercommentscreate-model',
  templateUrl: './ordercommentscreate-model.component.html',
  styleUrls: ['./ordercommentscreate-model.component.scss']
})
export class OrdercommentscreateModelComponent implements OnInit {

...
@Component({
  selector: 'vex-ebayallproducts-model',
  templateUrl: './ebayallproducts-model.component.html',
  styleUrls: ['./ebayallproducts-model.component.scss']
})
export class EbayallproductsModelComponent implements OnInit {
  ...
  testconnection(){
    this.urlApi.getAllProducts(this.id).subscribe(() => {},(token:any) => {
      // debugger;
      console.log(token);

...
@Component({
  selector: 'vex-bulkemail-model',
  templateUrl: './bulkemail-model.component.html',
  styleUrls: ['./bulkemail-model.component.scss']
})
export class BulkemailModelComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const data = {
      ...
      invoiceOnly: false,
      attachLabel: false,
      dontShowPrices: false,
      includeOrderConfirmationCallbackUrl: false,
      subject: '',
      toaddress:'', 

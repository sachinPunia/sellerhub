...
@Component({
  selector: 'vex-plukmail-model',
  templateUrl: './plukmail-model.component.html',
  styleUrls: ['./plukmail-model.component.scss'],
...
export class PlukmailModelComponent implements OnInit {

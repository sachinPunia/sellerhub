...
@Component({
  selector: 'vex-ebayrecentproducts-model',
  templateUrl: './ebayrecentproducts-model.component.html',
  styleUrls: ['./ebayrecentproducts-model.component.scss']
})
export class EbayrecentproductsModelComponent implements OnInit {
  ...
  testconnection(){
    this.urlApi.getRecentProducts(this.id).subscribe(() => {},(token:any) => {
      // debugger;
      console.log(token);
      this.result = token.error.text;
      // debugger;
      // const w: any = window;

...
@Component({
  selector: 'vex-picklist-model',
  templateUrl: './picklist-model.component.html',
  styleUrls: ['./picklist-model.component.scss']
})
export class PicklistModelComponent implements OnInit {

...
@Component({
  selector: 'vex-plyodel-model',
  templateUrl: './plyodel-model.component.html',
  styleUrls: ['./plyodel-model.component.scss'],
...
export class PlyodelModelComponent implements OnInit {

...
@Component({
  selector: 'vex-ordercommentsshow-model',
  templateUrl: './ordercommentsshow-model.component.html',
  styleUrls: ['./ordercommentsshow-model.component.scss']
})
export class OrdercommentsshowModelComponent implements OnInit {
